 ...
 if (isset($_POST["email"]) && !empty($_POST["email"]))
	{
      ...
      // Set required parameters for making an SMTP connection
				...
				$mail->Username   = "healing.admiiiin@gmail.com	";
				...
				$content = "<b>Bonjour , Pour modifier ton mot de passe il faut cliquer sur ce <a href='http://localhost/healing/views/updatepwd.php?Id=$message'>Lien</a></b>";
