     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i class="fa fa-h-square"></i>ealthing.tn</a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="#about" class="smoothScroll">Forum</a></li>
                         <li><a href="#team" class="smoothScroll">Produit</a></li>
                         <li class="appointment-btn"><a href="#appointment">Reservé votre rendez_vous</a></li>
                    </ul>
               </div>
